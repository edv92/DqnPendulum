...
if __name__ == "__main__":
    ...
    for episode in range(num_episodes):
        ...
        current_obs = np.array([np.random.uniform(270*(pi/180),90*(pi/180)),0,0,0])
        step_count = 0
        ...
        for steps in range(num_steps):
            ...
            reward = p_obj.getReward(current_obs[0], theta_max, current_obs[1], x_lim, pi, -pi)
            total_reward += reward
            ...
            if target_steps >= target_update:
                ...
                torch.save(target_net.state_dict(),f"models4/{episode}.pth")
